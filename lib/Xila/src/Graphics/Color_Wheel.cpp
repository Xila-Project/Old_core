...
#include "Graphics/Color_Wheel.hpp"
...
void Color_Wheel_Class::Create(Object_Class Parent_Object, bool Knob_Recolor)
{
    if (Parent_Object)
    {
        ...
        this->LVGL_Object_Pointer = lv_colorwheel_create(Parent_Object, Knob_Recolor);
    }
}

// - - Getters

Color_Wheel_Mode_Type Color_Wheel_Class::Get_Mode()
{
    Auto_Semaphore_Type Semaphore = Graphics.Take_Semaphore_Auto();
    return static_cast<Color_Wheel_Mode_Type>(lv_colorwheel_get_color_mode(Get_Pointer()));
}
...
void Color_Wheel_Class::Set_Mode(Color_Wheel_Mode_Type Mode)
{
    Auto_Semaphore_Type Semaphore = Graphics.Take_Semaphore_Auto();
    lv_colorwheel_set_mode(Get_Pointer(), static_cast<lv_colorwheel_mode_t>(Mode));
}
