...
static be_define_const_map_slots(m_libCommunication_map) {
    ...
    { be_const_key(Start, -1), be_const_ctype_func(Berry_Communication_Class_Start_6ECE3DAB_EB13_42E0_8A4A_C2E6B4343614) },
    ...
    { be_const_key(Stop, 22), be_const_ctype_func(Berry_Communication_Class_Stop_01232C22_DE8F_4225_9E35_A6A550AB50EF) },
