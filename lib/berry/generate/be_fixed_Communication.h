...
static be_define_const_map_slots(m_libCommunication_map) {
    ...
    { be_const_key(Start, -1), be_const_ctype_func(Berry_Communication_Class_Start_174EC8EF_D5D4_4C53_9802_5B46D906927B) },
    ...
    { be_const_key(Stop, 22), be_const_ctype_func(Berry_Communication_Class_Stop_E456240A_3C4C_4BE0_9408_3985F138767C) },
