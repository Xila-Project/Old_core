...
static be_define_const_map_slots(m_libCommunication_map) {
    ...
    { be_const_key(Start, -1), be_const_ctype_func(Berry_Communication_Class_Start_D16FEA69_599C_49B8_AB8E_CE0483047020) },
    ...
    { be_const_key(Stop, 22), be_const_ctype_func(Berry_Communication_Class_Stop_BD4C9116_3F8A_4D82_96A8_627531B878CC) },
