...
static be_define_const_map_slots(m_libCommunication_map) {
    ...
    { be_const_key(Start, -1), be_const_ctype_func(Berry_Communication_Class_Start_4C9437AA_1C34_4EB0_B114_11CBB21CC620) },
    ...
    { be_const_key(Stop, 22), be_const_ctype_func(Berry_Communication_Class_Stop_308D0142_E67E_4982_B7A6_02C90F4141A2) },
