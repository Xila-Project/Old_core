...
static be_define_const_map_slots(m_libGraphics_map) {
    ...
    { be_const_key(Symbol_Code_Left, 297), be_const_int(23) },
    ...
    { be_const_key(Opacity_Opacity_50_Percent, 62), be_const_int(127) },
    { be_const_key(Bar_Mode_Normal, 104), be_const_int(0) },
    { be_const_key(Grid_Alignment_Start, 85), be_const_int(0) },
    ...
    { be_const_key(Color_Format_Enumeration_User_Encoded_1, 319), be_const_int(31) },
    { be_const_key(Message_Dialog_Type, -1), be_const_class(Berry_Message_Dialog_Type) },
    { be_const_key(Direction_Horizontal, 99), be_const_int(3) },
    { be_const_key(Color_Format_Enumeration_User_Encoded_5, 25), be_const_int(35) },
    { be_const_key(Color_Format_Enumeration_True_Color_Chroma_Keyed, 316), be_const_int(6) },
    { be_const_key(Flex_Flow_Column_Wrap_Reverse, -1), be_const_int(13) },
    { be_const_key(Alignment_Out_Top_Middle, -1), be_const_int(11) },
    { be_const_key(Mode_Enumeration_Special, 207), be_const_int(2) },
    { be_const_key(Part_Scrollbar, -1), be_const_int(65536) },
    { be_const_key(Bar_Mode_Range, 274), be_const_int(2) },
    { be_const_key(Alignment_Bottom_Right, 253), be_const_int(6) },
    { be_const_key(Color_Wheel_Mode_Value, -1), be_const_int(2) },
    { be_const_key(Enumeration_Reverse, 224), be_const_int(2) },
    ...
    { be_const_key(Button_Matrix_Control_Checkable, 178), be_const_int(128) },
    { be_const_key(Symbol_Code_Shuffle, -1), be_const_int(30) },
    { be_const_key(Opacity_Opacity_70_Percent, 308), be_const_int(178) },
    ...
    { be_const_key(Event_Code_Insert, 98), be_const_int(29) },
    ...
    { be_const_key(Opacity_Opacity_100_Percent, 112), be_const_int(255) },
    { be_const_key(Mode_Enumeration_Number, -1), be_const_int(3) },
    { be_const_key(Set_Theme_Dark_Mode, 202), be_const_ctype_func(Berry_Graphics_Class_Set_Theme_Dark_Mode_1CD881F0_BB7F_4B1D_A15D_B0D91C30AEE1) },
    { be_const_key(Task_Function, -1), be_const_ctype_func(Berry_Graphics_Class_Task_Function_7BE9E43D_6EF7_4320_A55B_EAB2BF998281) },
    { be_const_key(Mode_Enumeration_User_3, -1), be_const_int(6) },
    { be_const_key(Event_Code_Layout_Changed, -1), be_const_int(43) },
    { be_const_key(Color_Format_Enumeration_User_Encoded_6, 229), be_const_int(36) },
    { be_const_key(Get_Font, -1), be_const_ctype_func(Berry_Graphics_Class_Get_Font_6E4C006D_B426_4CE1_A38A_B115159BE39F) },
    ...
    { be_const_key(Symbol_Code_Save, 115), be_const_int(39) },
    { be_const_key(Direction_Top, -1), be_const_int(4) },
    { be_const_key(Flag_Event_Bubble, 83), be_const_int(16384) },
    { be_const_key(Flag_Clickable, -1), be_const_int(2) },
    { be_const_key(Give_Semaphore, -1), be_const_ctype_func(Berry_Graphics_Class_Give_Semaphore_3790F036_90B7_4552_8BD7_99796EFE113D) },
    { be_const_key(Flag_Custom_1, -1), be_const_int(134217728) },
    { be_const_key(Table_Cell_Control_Custom_4, 71), be_const_int(128) },
    { be_const_key(Color_Format_Enumeration_Indexed_4_Bits, -1), be_const_int(9) },
    { be_const_key(Flag_Floating, -1), be_const_int(262144) },
    { be_const_key(Event_Code_Leave, 307), be_const_int(16) },
    { be_const_key(Spinbox_Type, -1), be_const_class(Berry_Spinbox_Type) },
    { be_const_key(Event_Code_Scroll_End, 293), be_const_int(10) },
    { be_const_key(Opacity_Opacity_20_Percent, -1), be_const_int(51) },
    { be_const_key(Color_Filter_Descriptor_Type, 278), be_const_class(Berry_Color_Filter_Descriptor_Type) },
    ...
    { be_const_key(Flex_Alignment_Space_Evenly, 209), be_const_int(3) },
    { be_const_key(Alignment_Out_Left_Top, -1), be_const_int(16) },
    { be_const_key(Symbol_Code_Plus, 133), be_const_int(25) },
    ...
    { be_const_key(Take_Semaphore, 137), be_const_ctype_func(Berry_Graphics_Class_Take_Semaphore_D956C27A_8527_4701_919B_4797D3C510AC) },
    { be_const_key(Direction_Bottom, 315), be_const_int(8) },
    { be_const_key(Event_Code_Minimize, -1), be_const_int(46) },
    { be_const_key(Alignment_Top_Middle, -1), be_const_int(2) },
    { be_const_key(Table_Cell_Control_Text_Crop, 183), be_const_int(2) },
    { be_const_key(Flex_Flow_Wrap, -1), be_const_int(4) },
    { be_const_key(Event_Code_Value_Changed, 160), be_const_int(28) },
    { be_const_key(Direction_All, 256), be_const_int(15) },
    { be_const_key(Event_Code_Focused, -1), be_const_int(14) },
    { be_const_key(Button_Matrix_Control_Custom_2, 295), be_const_int(32768) },
    ...
    { be_const_key(Flex_Alignment_End, 48), be_const_int(1) },
    { be_const_key(Color_Format_Enumeration_User_Encoded_7, 63), be_const_int(37) },
    { be_const_key(Event_Code_Defocused, 306), be_const_int(15) },
    ...
    { be_const_key(Event_Code_Delete, 320), be_const_int(33) },
    { be_const_key(Line_Type, 101), be_const_class(Berry_Line_Type) },
    ...
    { be_const_key(Get_Top_Layer, -1), be_const_ctype_func(Berry_Graphics_Class_Get_Top_Layer_17EF530E_906D_4D0F_98E0_812C6844F3B6) },
    { be_const_key(Color_Format_Enumeration_Reserved_21, 332), be_const_int(27) },
    { be_const_key(Symbol_Code_Backspace, 66), be_const_int(58) },
    { be_const_key(Flag_Scroll_Momentum, -1), be_const_int(64) },
    { be_const_key(Enumeration_Symmetrical, 57), be_const_int(1) },
    { be_const_key(Part_Placeholder, 245), be_const_int(524288) },
    { be_const_key(Mode_Enumeration_User_4, -1), be_const_int(7) },
    { be_const_key(Set_Theme_Secondary_Color, -1), be_const_ctype_func(Berry_Graphics_Class_Set_Theme_Secondary_Color_5BF77C1C_4D57_47FC_9225_C95E2617ED23) },
    ...
    { be_const_key(Opacity_Transparent, 301), be_const_int(0) },
    { be_const_key(Event_Code_Screen_Loaded, 321), be_const_int(39) },
    ...
    { be_const_key(Alignment_Default, 41), be_const_int(0) },
    { be_const_key(Event_Code_Refresh, -1), be_const_int(30) },
    { be_const_key(Flag_Gesture_Bubble, 169), be_const_int(32768) },
    { be_const_key(Part_Items, -1), be_const_int(327680) },
    { be_const_key(Part_Main, -1), be_const_int(0) },
    { be_const_key(Roller_Mode_Normal, 221), be_const_int(0) },
    ...
    { be_const_key(Get_Symbol, 335), be_const_ctype_func(Berry_Graphics_Class_Get_Symbol_CD5AC6A6_1080_4E81_895D_961AC92F9FDB) },
    { be_const_key(Direction_Left, 141), be_const_int(1) },
    { be_const_key(State_Custom_4, -1), be_const_int(32768) },
    { be_const_key(Get_Theme_Secondary_Color, -1), be_const_ctype_func(Berry_Graphics_Class_Get_Theme_Secondary_Color_D1AE82B3_5732_42F6_8941_EBEDB9B606A9) },
    { be_const_key(Alignment_Out_Left_Middle, 190), be_const_int(17) },
    ...
    { be_const_key(Long_Wrap, 226), be_const_int(0) },
    { be_const_key(Border_Side_Left, -1), be_const_int(4) },
    { be_const_key(Color_Format_Enumeration_User_Encoded_4, -1), be_const_int(34) },
    { be_const_key(Flag_Press_Lock, 279), be_const_int(8192) },
    { be_const_key(Get_Theme_Primary_Color, -1), be_const_ctype_func(Berry_Graphics_Class_Get_Theme_Primary_Color_1AF57408_7C43_41CB_813F_5244038CC7A7) },
    { be_const_key(Flag_Ignore_Layout, 16), be_const_int(131072) },
    ...
    { be_const_key(Set_Theme_Primary_Color, 299), be_const_ctype_func(Berry_Graphics_Class_Set_Theme_Primary_Color_6B27938D_D4E8_4EC9_ADEE_CEEDA4892E94) },
    { be_const_key(Alignment_Out_Top_Right, -1), be_const_int(12) },
    { be_const_key(Flag_Adv_Hittest, 37), be_const_int(65536) },
    { be_const_key(Table_Cell_Control_Custom_1, 128), be_const_int(16) },
    ...
    { be_const_key(Event_Code_All, 275), be_const_int(0) },
    ...
    { be_const_key(Image_Type, 119), be_const_class(Berry_Image_Type) },
    { be_const_key(State_Focus_Key, 227), be_const_int(4) },
    ...
    { be_const_key(Flex_Flow_Row, 206), be_const_int(0) },
    { be_const_key(Color_Format_Enumeration_Indexed_8_Bits, -1), be_const_int(10) },
    { be_const_key(Symbol_Code_Cut, 273), be_const_int(37) },
    { be_const_key(Flag_Overflow_Visible, -1), be_const_int(524288) },
    { be_const_key(State_Custom_1, -1), be_const_int(4096) },
    { be_const_key(Window_State_Windowed, 36), be_const_int(1) },
    { be_const_key(Flex_Alignment_Space_Between, -1), be_const_int(5) },
    { be_const_key(Object_Type, 302), be_const_class(Berry_Object_Type) },
    { be_const_key(Symbol_Code_Stop, 181), be_const_int(20) },
    { be_const_key(Button_Matrix_Control_Custom_1, 269), be_const_int(16384) },
    { be_const_key(Button_Matrix_Control_Recolor, 51), be_const_int(2048) },
    { be_const_key(Event_Code_Pressing, -1), be_const_int(2) },
    { be_const_key(Symbol_Code_Dummy, 263), be_const_int(61) },
    { be_const_key(Flag_Scroll_Elastic, 23), be_const_int(32) },
    { be_const_key(Label_Type, 288), be_const_class(Berry_Label_Type) },
    ...
    { be_const_key(Event_Code_Short_Clicked, 6), be_const_int(4) },
    { be_const_key(Color_Format_Enumeration_Reserved_23, 136), be_const_int(29) },
    { be_const_key(Get_Percentage, 230), be_const_ctype_func(Berry_Graphics_Class_Get_Percentage_E1886770_D8EC_4CB2_8F1A_BDC90B74308A) },
    { be_const_key(Direction_None, -1), be_const_int(0) },
    { be_const_key(Window_State_Maximized, 89), be_const_int(2) },
    ...
    { be_const_key(Flag_Click_Focusable, 17), be_const_int(4) },
    { be_const_key(Event_Code_Get_Self_Size, -1), be_const_int(44) },
    { be_const_key(Flag_Custom_4, 9), be_const_int(1073741824) },
    { be_const_key(Color_Wheel_Type, -1), be_const_class(Berry_Color_Wheel_Type) },
    { be_const_key(Part_Indicator, 168), be_const_int(131072) },
    { be_const_key(Symbol_Code_Bullet, 34), be_const_int(0) },
    ...
    { be_const_key(Long_Scroll_Circular, 148), be_const_int(3) },
    { be_const_key(Event_Code_Size_Changed, 201), be_const_int(41) },
    ...
    { be_const_key(Bar_Mode_Symmetrical, 292), be_const_int(1) },
    { be_const_key(Symbol_Code_Ok, 313), be_const_int(4) },
    { be_const_key(Alignment_Top_Right, 322), be_const_int(3) },
    ...
    { be_const_key(Symbol_Code_Envelope, 188), be_const_int(41) },
    { be_const_key(Event_Code_Extra_Draw_Size, 287), be_const_int(19) },
    ...
    { be_const_key(Slider_Mode_Symmetrical, 225), be_const_int(1) },
    ...
    { be_const_key(Table_Cell_Control_Custom_3, 282), be_const_int(64) },
    { be_const_key(State_Checked, 303), be_const_int(1) },
    ...
    { be_const_key(Opacity_Opacity_0_Percent, 163), be_const_int(0) },
    ...
    { be_const_key(Keyboard_Type, 97), be_const_class(Berry_Keyboard_Type) },
    ...
    { be_const_key(Border_Side_Internal, 100), be_const_int(16) },
    ...
    { be_const_key(Color_Format_Enumeration_Reserved_16, 254), be_const_int(22) },
    ...
    { be_const_key(Switch_Type, 214), be_const_class(Berry_Switch_Type) },
    { be_const_key(Start, -1), be_const_ctype_func(Berry_Graphics_Class_Start_39BAA628_A765_487B_9CB0_4CF7AA0123BB) },
    ...
    { be_const_key(Border_Side_None, 54), be_const_int(0) },
    { be_const_key(Symbol_Code_Keyboard, 212), be_const_int(45) },
    { be_const_key(Get_Pointer, 58), be_const_ctype_func(Berry_Graphics_Class_Get_Pointer) },
    { be_const_key(Event_Code_Cancel, 184), be_const_int(32) },
    { be_const_key(Event_Code_Style_Changed, -1), be_const_int(42) },
    { be_const_key(Event_Code_Press_Lost, 153), be_const_int(3) },
    ...
    { be_const_key(Area_Type, 122), be_const_class(Berry_Area_Type) },
    ...
    { be_const_key(Table_Cell_Control_Custom_2, 193), be_const_int(32) },
    ...
    { be_const_key(Event_Code_Gesture, 72), be_const_int(12) },
    ...
    { be_const_key(Color_Type, 252), be_const_class(Berry_Color_Type) },
    ...
    { be_const_key(Stop, -1), be_const_ctype_func(Berry_Graphics_Class_Stop_31B6213E_BD8B_4503_8EE8_F0CD3291AD71) },
    ...
    { be_const_key(Get_Theme_Dark_Mode, -1), be_const_ctype_func(Berry_Graphics_Class_Get_Theme_Dark_Mode_93A660F2_3BBA_48F0_9615_3DD1B809A493) },
    { be_const_key(Opacity_Opacity_90_Percent, 272), be_const_int(229) },
