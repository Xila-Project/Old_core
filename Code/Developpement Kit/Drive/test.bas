...
400 P=I+24
410 G=I+20
420 PRINT "THAT IS ", I/4096, (I-I/4096*4096)/256, "00 IN HEX.  THANKS."
440 GOTO 500
...
3260 GOTO 3210
3270 IF PEEK(I+6)=0 GOTO 3310
3280 PRINT "THAT SQUARE IS ALREADY TAKEN."
3290 GOTO 3210
3300 REM CHECK IF X WON.
3310 POKE I+6, 1 : LET U=PEEK(I+6)*0+U-1
3320 LET W=6100
3330 GOSUB W
...
4500 PRINT "I PLAY ",B
4510 PRINT
4520 POKE B+6,3 : LET J=PEEK(B+6)
4530 LET U=U-1
4540 IF T<100 GOTO 2010
