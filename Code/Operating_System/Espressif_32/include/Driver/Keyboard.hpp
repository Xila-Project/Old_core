...
public:
    ...
    static const Keymap_Class Keymap_US;
    static const Keymap_Class Keymap_German;
    static const Keymap_Class Keymap_French;
    static const Keymap_Class Keymap_Spanish;
    static const Keymap_Class Keymap_Italian;
    static const Keymap_Class Keymap_UK;
 ...
 */
     ...
     */
    void begin(uint8_t dataPin, uint8_t irq_pin, const Keymap_Class &map = Keymap_US);
