...
/// @param Mode Mode.
void Pin_Class::Set_Mode(uint8_t Pin, uint8_t Mode)
{
    pinMode(Pin, Mode);
}
...
/// @param Pin Involved GPIO.
/// @return Result::Type
Module_Class::Result::Type Pin_Class::Valid_Output_Pin(uint8_t Pin)
{
...
void Pin_Class::Digital_Write(uint8_t Pin, uint8_t State)
{
...
int16_t Pin_Class::Digital_Read(uint8_t Pin)
{
...
/// @param Pin Involved GPIO.
/// @return Result::Type
Module_Class::Result::Type Pin_Class::Valid_Digital_Pin(uint8_t Pin)
{
...
///
/// @param Pin Involved GPIO.
void Pin_Class::Set_Voltage_Reference_Pin(uint8_t Pin)
{
...
void Pin_Class::Attach_Interrupt(uint8_t Pin, void (*Function_Pointer)(void), int16_t Mode)
{
...
/// @param Mode Interrupt mode.
void Pin_Class::Attach_Interrupt_Argument(uint8_t Pin, void (*Function_Pointer)(void *), void *Argument, int16_t Mode)
{
