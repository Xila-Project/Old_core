...
/// @param Mode Mode.
void GPIO_Class::Set_Mode(uint8_t Pin, uint8_t Mode)
{
    pinMode(Pin, Mode);
}
...
void GPIO_Class::Digital_Write(uint8_t Pin, uint8_t State)
{
...
int16_t GPIO_Class::Digital_Read(uint8_t Pin)
{
...
uint16_t GPIO_Class::Analog_Read(uint8_t Pin)
{
...
uint32_t GPIO_Class::Analog_Read_Milli_Volts(uint8_t Pin)
{
...
///
/// @param Pin Involved GPIO.
void GPIO_Class::Set_Voltage_Reference_Pin(uint8_t Pin)
{
...
void GPIO_Class::Set_Attenuation(uint8_t Pin, uint8_t Attenuation)
{
    switch (Attenuation)
    {
    case ADC_0db:
...
///
/// @param Attenuation Attenuation.
void GPIO_Class::Set_Attenuation(uint8_t Attenuation)
{
    switch (Attenuation)
    {
    case ADC_0db:
...
void GPIO_Class::Set_Clock_Divider(uint8_t Clock_Divider)
{
...
void GPIO_Class::Set_Width(uint8_t Bits_Width)
{
...
void GPIO_Class::Set_Read_Resolutions(uint8_t Bits_Resolution)
{
...
void GPIO_Class::Attach_Interrupt(uint8_t Pin, void (*Function_Pointer)(void), int16_t Mode)
{
...
/// @param Mode Interrupt mode.
void GPIO_Class::Attach_Interrupt_Argument(uint8_t Pin, void (*Function_Pointer)(void *), void *Argument, int16_t Mode)
{
...
///
/// @param Pin Involved GPIO.
void GPIO_Class::Detach_Interrupt(uint8_t Pin)
{
    detachInterrupt(Pin);
}
