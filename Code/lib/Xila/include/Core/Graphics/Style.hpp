...
namespace Xila_Namespace
{
    ...
    public:
        ...
        void Set_Arc_Opacity(Opacity_Type Opacity);
        ...
        void Set_Background_Image_Recolor_Opacity(Opacity_Type Opacity);
        ...
        void Set_Border_Opacity(Opacity_Type Opacity);
        void Set_Border_Post(bool Value);
        void Set_Border_Side(Border_Side_Type Border_Side);
        ...
        void Set_Color_Filter_Opacity(Opacity_Type Opacity);

        // - - - - Flex
        void Set_Flex_Cross_Place(Flex_Alignment_Type Cross_Place);
        void Set_Flex_Flow(Flex_Flow_Type Flow);
        void Set_Flex_Grow(uint8_t Value);
        void Set_Flex_Main_Place(Flex_Alignment_Type Main_Place);
        void Set_Flex_Track_Place(Flex_Alignment_Type Track_Place);
        ...
        void Set_Line_Opacity(Opacity_Type Opacity);
        ...
        void Set_Opacity(Opacity_Type Opacity);

        // - - - - Outline
        void Set_Outline_Color(Color_Type Color);
        void Set_Outline_Opacity(Opacity_Type Opacity);
        ...
        void Set_Shadow_Opacity(Opacity_Type Opacity);
        ...
        void Set_Text_Opacity(Opacity_Type Opacity);
