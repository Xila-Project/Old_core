...
be_define_const_str(_X21_X3D, "!=", 2428715011u, 0, 2, &be_const_str__X2Elen);
be_define_const_str(_X28_X29, "()", 685372826u, 0, 2, &be_const_str_Hello);
be_define_const_str(_X2B, "+", 772578730u, 0, 1, &be_const_str_end);
be_define_const_str(_X2E_X2E, "..", 2748622605u, 0, 2, &be_const_str_for);
be_define_const_str(_X2Elen, ".len", 850842136u, 0, 4, &be_const_str_member);
be_define_const_str(_X2Ep, ".p", 1171526419u, 0, 2, &be_const_str_as);
be_define_const_str(_X2Esize, ".size", 1965188224u, 0, 5, &be_const_str_load);
be_define_const_str(_X2Etest_var, ".test_var", 3611137359u, 0, 9, &be_const_str_isnan);
be_define_const_str(_X3D_X3D, "==", 2431966415u, 0, 2, &be_const_str___lower__);
be_define_const_str(Hello, "Hello", 4116459851u, 0, 5, &be_const_str_insert);
be_define_const_str(__iterator__, "__iterator__", 3884039703u, 0, 12, &be_const_str_atan2);
be_define_const_str(__lower__, "__lower__", 123855590u, 0, 9, &be_const_str_ceil);
be_define_const_str(__upper__, "__upper__", 3612202883u, 0, 9, &be_const_str_srand);
be_define_const_str(_buffer, "_buffer", 2044888568u, 0, 7, &be_const_str_pow);
be_define_const_str(_change_buffer, "_change_buffer", 2101848693u, 0, 14, &be_const_str_compile);
be_define_const_str(abs, "abs", 709362235u, 0, 3, &be_const_str_break);
be_define_const_str(acos, "acos", 1006755615u, 0, 4, &be_const_str_geti);
be_define_const_str(add, "add", 993596020u, 0, 3, &be_const_str_ismapped);
be_define_const_str(allocated, "allocated", 429986098u, 0, 9, &be_const_str_classname);
be_define_const_str(as, "as", 1579491469u, 67, 2, &be_const_str_if);
be_define_const_str(asin, "asin", 4272848550u, 0, 4, &be_const_str_collect);
be_define_const_str(assert, "assert", 2774883451u, 0, 6, &be_const_str_call);
be_define_const_str(asstring, "asstring", 1298225088u, 0, 8, NULL);
be_define_const_str(atan, "atan", 108579519u, 0, 4, &be_const_str_fromhex);
be_define_const_str(atan2, "atan2", 3173440503u, 0, 5, NULL);
be_define_const_str(attrdump, "attrdump", 1521571304u, 0, 8, &be_const_str_getbits);
be_define_const_str(bool, "bool", 3365180733u, 0, 4, NULL);
be_define_const_str(break, "break", 3378807160u, 58, 5, &be_const_str_imax);
be_define_const_str(byte, "byte", 1683620383u, 0, 4, &be_const_str_exists);
be_define_const_str(bytes, "bytes", 1706151940u, 0, 5, NULL);
be_define_const_str(call, "call", 3018949801u, 0, 4, &be_const_str_exit);
be_define_const_str(calldepth, "calldepth", 3122364302u, 0, 9, &be_const_str_pi);
be_define_const_str(ceil, "ceil", 1659167240u, 0, 4, &be_const_str_get);
be_define_const_str(char, "char", 2823553821u, 0, 4, &be_const_str_print);
be_define_const_str(chdir, "chdir", 806634853u, 0, 5, &be_const_str_getfloat);
be_define_const_str(class, "class", 2872970239u, 57, 5, &be_const_str_join);
be_define_const_str(classname, "classname", 1998589948u, 0, 9, &be_const_str_rad);
...
be_define_const_str(codedump, "codedump", 1786337906u, 0, 8, &be_const_str_time);
be_define_const_str(collect, "collect", 2399039025u, 0, 7, &be_const_str_log10);
be_define_const_str(compile, "compile", 1000265118u, 0, 7, &be_const_str_number);
be_define_const_str(concat, "concat", 4124019837u, 0, 6, &be_const_str_isdir);
be_define_const_str(contains, "contains", 1825239352u, 0, 8, &be_const_str_find);
be_define_const_str(continue, "continue", 2977070660u, 59, 8, &be_const_str_hex);
...
be_define_const_str(cosh, "cosh", 4099687964u, 0, 4, &be_const_str_counters);
be_define_const_str(count, "count", 967958004u, 0, 5, &be_const_str_seti);
be_define_const_str(counters, "counters", 4095866864u, 0, 8, &be_const_str_fromptr);
be_define_const_str(def, "def", 3310976652u, 55, 3, &be_const_str_tanh);
be_define_const_str(deg, "deg", 3327754271u, 0, 3, &be_const_str_setitem);
be_define_const_str(deinit, "deinit", 2345559592u, 0, 6, &be_const_str_set);
be_define_const_str(do, "do", 1646057492u, 65, 2, &be_const_str_format);
be_define_const_str(dump, "dump", 3663001223u, 0, 4, NULL);
be_define_const_str(elif, "elif", 3232090307u, 51, 4, &be_const_str_isfile);
be_define_const_str(else, "else", 3183434736u, 52, 4, &be_const_str_floor);
be_define_const_str(end, "end", 1787721130u, 56, 3, &be_const_str_ismethod);
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_path);
be_define_const_str(except, "except", 950914032u, 69, 6, &be_const_str_upper);
be_define_const_str(exists, "exists", 1002329533u, 0, 6, NULL);
be_define_const_str(exit, "exit", 3454868101u, 0, 4, &be_const_str_real);
be_define_const_str(exp, "exp", 1923516200u, 0, 3, &be_const_str_getcwd);
be_define_const_str(false, "false", 184981848u, 62, 5, &be_const_str_mkdir);
...
be_define_const_str(for, "for", 2901640080u, 54, 3, &be_const_str_init);
be_define_const_str(format, "format", 3114108242u, 0, 6, &be_const_str_return);
be_define_const_str(fromb64, "fromb64", 2717019639u, 0, 7, &be_const_str_imin);
be_define_const_str(fromhex, "fromhex", 1847150394u, 0, 7, &be_const_str_issubclass);
be_define_const_str(fromptr, "fromptr", 666189689u, 0, 7, &be_const_str_system);
be_define_const_str(fromstring, "fromstring", 610302344u, 0, 10, NULL);
be_define_const_str(get, "get", 1410115415u, 0, 3, &be_const_str_tob64);
be_define_const_str(getbits, "getbits", 3094168979u, 0, 7, &be_const_str_sqrt);
be_define_const_str(getcwd, "getcwd", 652026575u, 0, 6, &be_const_str_nan);
be_define_const_str(getfloat, "getfloat", 2820979603u, 0, 8, &be_const_str_top);
...
be_define_const_str(imax, "imax", 3084515410u, 0, 4, &be_const_str_import);
be_define_const_str(imin, "imin", 2714127864u, 0, 4, &be_const_str_members);
be_define_const_str(import, "import", 288002260u, 66, 6, &be_const_str_rand);
be_define_const_str(init, "init", 380752755u, 0, 4, NULL);
be_define_const_str(input, "input", 4191711099u, 0, 5, &be_const_str_tolower);
be_define_const_str(insert, "insert", 3332609576u, 0, 6, &be_const_str_keys);
be_define_const_str(int, "int", 2515107422u, 0, 3, NULL);
be_define_const_str(isdir, "isdir", 2340917412u, 0, 5, &be_const_str_open);
...
be_define_const_str(ismapped, "ismapped", 2725004770u, 0, 8, &be_const_str_tostring);
...
be_define_const_str(iter, "iter", 3124256359u, 0, 4, &be_const_str_splitext);
...
be_define_const_str(members, "members", 937576464u, 0, 7, &be_const_str_remove);
be_define_const_str(mkdir, "mkdir", 2883839448u, 0, 5, &be_const_str_type);
be_define_const_str(module, "module", 3617558685u, 0, 6, &be_const_str_pop);
be_define_const_str(nan, "nan", 797905850u, 0, 3, NULL);
be_define_const_str(nil, "nil", 228849900u, 63, 3, &be_const_str_raise);
...
be_define_const_str(pow, "pow", 1479764693u, 0, 3, &be_const_str_tohex);
be_define_const_str(print, "print", 372738696u, 0, 5, &be_const_str_true);
be_define_const_str(push, "push", 2272264157u, 0, 4, &be_const_str_setfloat);
...
be_define_const_str(real, "real", 3604983901u, 0, 4, &be_const_str_sethook);
be_define_const_str(remove, "remove", 3683784189u, 0, 6, &be_const_str_size);
be_define_const_str(replace, "replace", 2704835779u, 0, 7, &be_const_str_resize);
be_define_const_str(resize, "resize", 3514612129u, 0, 6, &be_const_str_setbytes);
be_define_const_str(return, "return", 2246981567u, 60, 6, &be_const_str_setmodule);
be_define_const_str(reverse, "reverse", 558918661u, 0, 7, NULL);
be_define_const_str(set, "set", 3324446467u, 0, 3, &be_const_str_setbits);
be_define_const_str(setbits, "setbits", 2762408167u, 0, 7, &be_const_str_static);
be_define_const_str(setbytes, "setbytes", 197507254u, 0, 8, NULL);
be_define_const_str(setfloat, "setfloat", 2799488807u, 0, 8, &be_const_str_setrange);
...
be_define_const_str(setmember, "setmember", 1432909441u, 0, 9, &be_const_str_sin);
be_define_const_str(setmodule, "setmodule", 2354663567u, 0, 9, &be_const_str_upvname);
...
be_define_const_str(splitext, "splitext", 2150391934u, 0, 8, &be_const_str_traceback);
...
be_define_const_str(str, "str", 3259748752u, 0, 3, &be_const_str_tan);
...
be_define_const_str(top, "top", 2802900028u, 0, 3, &be_const_str_tr);
...
be_define_const_str(try, "try", 2887626766u, 68, 3, &be_const_str_value_error);
