...
static be_define_const_map_slots(m_libCommunication_map) {
    ...
    { be_const_key(Start, -1), be_const_ctype_func(Berry_Communication_Class_Start_01DB4A3D_4BDA_4FB8_B72C_6991E8DE3DCF) },
    ...
    { be_const_key(Stop, 22), be_const_ctype_func(Berry_Communication_Class_Stop_881512FE_FF85_4D64_B896_05210C8E0766) },
