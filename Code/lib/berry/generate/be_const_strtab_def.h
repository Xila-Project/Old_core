...
be_define_const_str(_X2Elen, ".len", 850842136u, 0, 4, &be_const_str_yesno);
be_define_const_str(_X2Ep, ".p", 1171526419u, 0, 2, NULL);
be_define_const_str(_X2Esize, ".size", 1965188224u, 0, 5, &be_const_str_make_cb);
be_define_const_str(_X3D_X3D, "==", 2431966415u, 0, 2, NULL);
be_define_const_str(Clap, "Clap", 3276884387u, 0, 4, &be_const_str_getcwd);
be_define_const_str(Foo, "Foo", 209589879u, 0, 3, &be_const_str_classof);
...
be_define_const_str(addint, "addint", 1304715213u, 0, 6, &be_const_str_asstring);
...
be_define_const_str(asin, "asin", 4272848550u, 0, 4, &be_const_str_gen_cb);
...
be_define_const_str(classname, "classname", 1998589948u, 0, 9, &be_const_str_set);
...
be_define_const_str(fromb64, "fromb64", 2717019639u, 0, 7, &be_const_str_get_cb_list);
...
be_define_const_str(ftoc, "ftoc", 1398290641u, 0, 4, &be_const_str_join);
be_define_const_str(gen_cb, "gen_cb", 3245227551u, 0, 6, NULL);
be_define_const_str(get, "get", 1410115415u, 0, 3, NULL);
be_define_const_str(get_cb_list, "get_cb_list", 1605319182u, 0, 11, &be_const_str_module);
...
be_define_const_str(if, "if", 959999494u, 50, 2, &be_const_str_sethook);
...
be_define_const_str(isinstance, "isinstance", 3669352738u, 0, 10, &be_const_str_real);
...
be_define_const_str(list_handlers, "list_handlers", 593774371u, 0, 13, &be_const_str_lower);
...
be_define_const_str(log, "log", 1062293841u, 0, 3, &be_const_str_number);
...
be_define_const_str(make_cb, "make_cb", 71252785u, 0, 7, &be_const_str_setmember);
...
be_define_const_str(print, "print", 372738696u, 0, 5, &be_const_str_varname);
...
be_define_const_str(return, "return", 2246981567u, 60, 6, &be_const_str_upvname);
...
be_define_const_str(sethook, "sethook", 3963967276u, 0, 7, &be_const_str_tr);
...
be_define_const_str(yesno, "yesno", 436467439u, 0, 5, NULL);
...
static const bstring* const m_string_table[] = {
    ...
    (const bstring *)&be_const_str_addint,
    ...
    (const bstring *)&be_const_str_Clap,
