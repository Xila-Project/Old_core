...
be_define_const_str(_X21_X3D, "!=", 2428715011u, 0, 2, &be_const_str_make_cb);
be_define_const_str(_X28_X29, "()", 685372826u, 0, 2, &be_const_str_end);
be_define_const_str(_X2B, "+", 772578730u, 0, 1, &be_const_str_collect);
be_define_const_str(_X2E_X2E, "..", 2748622605u, 0, 2, &be_const_str_varname);
...
be_define_const_str(__lower__, "__lower__", 123855590u, 0, 9, &be_const_str_list_handlers);
...
be_define_const_str(add_handler, "add_handler", 2055124119u, 0, 11, &be_const_str_cosh);
be_define_const_str(addint, "addint", 1304715213u, 0, 6, &be_const_str_call);
...
be_define_const_str(assert, "assert", 2774883451u, 0, 6, &be_const_str_get_cb_list);
...
be_define_const_str(chdir, "chdir", 806634853u, 0, 5, &be_const_str_gen_cb);
...
be_define_const_str(count, "count", 967958004u, 0, 5, &be_const_str_sethook);
...
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_ftoc);
...
be_define_const_str(ftoc, "ftoc", 1398290641u, 0, 4, &be_const_str_system);
be_define_const_str(gen_cb, "gen_cb", 3245227551u, 0, 6, &be_const_str_listdir);
be_define_const_str(get, "get", 1410115415u, 0, 3, &be_const_str_hex);
be_define_const_str(get_cb_list, "get_cb_list", 1605319182u, 0, 11, &be_const_str_isdir);
...
be_define_const_str(make_cb, "make_cb", 71252785u, 0, 7, &be_const_str_setbits);
...
be_define_const_str(pop, "pop", 1362321360u, 0, 3, &be_const_str_setfloat);
...
be_define_const_str(sethook, "sethook", 3963967276u, 0, 7, &be_const_str_seti);
...
be_define_const_str(size, "size", 597743964u, 0, 4, &be_const_str_yesno);
