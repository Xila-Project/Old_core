      ...
      case INFORMATION_NEXTION_STRING_DATA_ENCLOSED :
        switch(Return_Code[2])
        {
          ...
          case CODE_COMMAND : //* - command    
              ...
              if (Command == "LoadSystem") GalaxOS.Load_System_Files();
              else if (Command == "LoadUser") GalaxOS.Load_User_Files();
              else if (Command == "Menu") GalaxOS.Open_Menu();
              else if (Command == "Desk") GalaxOS.Open_Desk();
              //event handler
          ...
          case CODE_CONSTRUCT:
            ...
            if (Command == "ULTRASON") GalaxOS.Ultrasonic_Pointer = new Ultrasonic_Class;
            break;
          case CODE_DESTRUCT:
            while(uxQueueMessagesWaiting(Nextion_Serial_Queue) != 0)
            {
            ...
            if (Command == "ULTRASON") delete GalaxOS.Ultrasonic_Pointer;
            break;
