...
"-----END CERTIFICATE-----\n";
  ...
  WiFi_Client.setCACert(rootCACertificate);
  ...
  /*WiFi_Client.connect(URLserver, 80)
  ...
  if (HTTP_Client.begin(WiFi_Client, URL)) // Connect to server and request HTML
  {
  ...
  HTTP_Return_Code = HTTP_Client.GET();
